...
<div style="width: 75%; color: white;">
  ...
  <p>💻 Coding My Way Through MERN Stack | HTML, CSS, JS, BOOTSTRAP, TAILWIND, REACT JS, NODE JS, EXPSS JS, MONGO DB, MY SQL, VS CODE, GIT GITHUB | Exploring the Power of C, C++, and Python 🐍</p> <p>🌐 Web Development Enthusiast | 🔥 Problem Solver | 🚀 Tech Explorer</p> <p>🤝 Always up for teaming up on fun coding projects and challenges!</p> <p>📩 Reach out: khandelwalharshit2024@gmail.com</p> <p>✨ Let’s Code Something Amazing Together! ✨</p>
     </div>
